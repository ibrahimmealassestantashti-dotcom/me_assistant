...
def extract_session_metrics_with_ai(service, session_info, api_key, model_name):
    ...
    try:
        ...
        2. نظام الترميز في ورقة الحضور (مهم جداً، اتبعه بدقة):
           ...
           - في أعلى الورقة يوجد مربع صغير يحتوي على الأعداد الإجمالية الجاهزة (عدد الحضور وعدد الغياب) مكتوبة يدوياً من معدّ الورقة - اعتمد على هذه الأرقام المكتوبة في المربع الصغير كمصدر أساسي وموثوق للعدد الإجمالي، ولا تكتفِ بعدّ الأسماء يدوياً إلا إذا كان المربع غير واضح أو غير موجود.
